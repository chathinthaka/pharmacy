...
if ($Aa=='User'){
  //check if the page is opened by not admins           
            ...
            <div class="card-body">
                        ...
                        <form role="form" method="post" action="cust_transac.php?action=add">
                          <div class="form-group">
                              <input class="form-control" placeholder="Customer Name" name="firstname" required>
                            </div>
                            <div class="form-group">
                              <input class="form-control" placeholder="Address" name="lastname" required>
                            </div>
                            <div class="form-group">
